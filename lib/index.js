...
function render (tree, options) {
   ...
   * Formats:
   *
   * ``` tag: `<br></br>` ```, slash: `<br />` ```, slashMin: `<br/>` ```, ```default: `<br>` ```
   */
  options = options || {}
    ...
    traverse(tree, function (node) {
      ...
      if (isSingleTag(tag)) {
        switch (closingSingleTag) {
          ...
          case 'slashMin':
            if (attrsResult.match(/[^"']$/)) {
              // Unquoted attribute must be separated from self closing tag, otherwise the / will be considered part of the attribute value.
              result += ' '
            }
